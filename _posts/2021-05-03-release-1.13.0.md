...
* [FLINK-19463](https://issues.apache.org/jira/browse/FLINK-19463) - The old `StateBackend` interfaces were deprecated
  ...
  For full details on how to update existing pipelines, please see the [migration guide]({{ site.DOCS_BASE_URL }}flink-docs-release-1.13/docs/ops/state/state_backends/#migrating-from-legacy-backendsdocs/ops/state/state_backends/#). 
