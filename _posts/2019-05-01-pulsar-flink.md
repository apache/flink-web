...
excerpt: Apache Flink and Apache Pulsar can integrate in different ways and provide elastic data processing at large scale. This post describes the ways that Pulsar and Flink can work together to provide a seamless developer experience for elastic data processing at scale. 
---
...
```java
// obtain DataSet from computation
