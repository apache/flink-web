...
<div class="row-fluid">
  ...
  <div class="powered-by-tile col-md-3 col-sm-4 col-xs-6">
    <img src="{{ site.baseurl }}/img/poweredby/kuaishou-logo.jpg" alt="Kuaishou" /><br />
        Kuaishou, one of the leading short video sharing apps in China, use Apache Flink to build a real-time monitoring platform of short video and live streaming.
