...
- **ASF read-only**: git://git.apache.org/flink.git
...
- Robert Metzger, Patrick Lucas: **data Artisans Product Announcement** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/data-artisans-product-announcement)
- Patrick Lucas: **Flink in Containerland** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-patrick-lucas-flink-in-containerland)
- Nico Kruber: **Building a network stack for optimal throughput / low-latency trade-offs** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-nico-kruber-building-a-network-stack-for-optimal-throughput-lowlatency-tradeoffs)
- Till Rohrmann: **From Apache Flink 1.3 to 1.4** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-till-rohrmann-from-apache-flink-13-to-14)
- Till Rohrmann, Jörg Schad: **Apache Flink meets Apache Mesos and DC/OS** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-jrg-schad-till-rohrmann-apache-flink-meets-apache-mesos-and-dcos)
- Piotr Nowojski: **"Hit me, baby, just one time" - Building End-to-End Exactly-Once Applications with Flink** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-piotr-nowojski-hit-me-baby-just-one-time-building-endtoend-exactlyonce-applications-with-flink)
- Stephan Ewen, Flavio Junqueira: **Connecting Apache Flink and the Pravega Stream Store** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-stephan-ewen-flavio-junqueira-connecting-apache-flink-and-the-pravega-stream-store)
- Stefan Richter: **A look at Flink's internal data structures and algorithms for efficient checkpointing** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-stefan-richter-a-look-at-flinks-internal-data-structures-and-algorithms-for-efficient-checkpointing)
- Timo Walther: **From Streams to Tables and Back Again: A Demo of Flink's Table & SQL API** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-timo-wahlter-from-streams-to-tables-and-back-again-a-demo-of-flinks-table-sql-api)
- Robert Metzger: **Keep it going - How to reliably and efficiently operate Apache Flink** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-robert-metzger-keep-it-going-how-to-reliably-and-efficiently-operate-apache-flink)
- Stephan Ewen: **The State of Flink and how to adopt Stream Processing** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-stephan-ewen-the-state-of-flink-and-how-to-adopt-stream-processing)
- Kostas Kloudas: **Complex Event Processing with Flink: The state of FlinkCEP** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-kostas-kloudas-complex-event-processing-with-flink-the-state-of-flinkcep)
- Fabian Hueske: **Using Stream and Batch Processing with Apache Flink's Relational APIs** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/using-stream-and-batch-processing-with-apache-flinks-relational-apis)
- Tzu-Li (Gordon) Tai: **Managing State in Apache Flink** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-tzuli-gordon-tai-managing-state-in-apache-flink)
- Aljoscha Krettek: **Talk Python to me: Stream Processing in Your Favourite Language with Beam on Flink** *Flink Forward Berlin, September 2017*: [SlideShare](https://www.slideshare.net/FlinkForward/flink-forward-berlin-2017-aljoscha-krettek-talk-python-to-me-stream-processing-in-your-favourite-language-with-beam-on-flink)
...
- Till Rohrmann: **Dynamic Scaling - How Apache Flink adapts to changing workloads** *Flink Forward, Berlin September 2016*: [SlideShare](http://www.slideshare.net/FlinkForward/till-rohrmann-dynamic-scaling-how-apache-flink-adapts-to-changing-workloads)
