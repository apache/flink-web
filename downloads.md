...
file system connector), please check out the [Hadoop YARN]({{ site.DOCS_BASE_URL }}flink-docs-release-{{ site.FLINK_VERSION_STABLE_SHORT }}/deployment/resource-providers/yarn.html) documentation.
