...
<div class="frontpage-tags">
  ...
  <div class="row" style="margin-top: 1em">
    <div class="col-md-12"><p class="text-center"><strong>Check out the <a href="{{ site.baseurl }}/features.html" class="frontpage-tags">Features</a> page to get a tour of all major Flink features and the <a href="{{ site.baseurl }}/production.html" class="frontpage-tags">Flink in Production</a> page to see real-world Flink use cases.</strong></p></div>
  </div>
</div>
