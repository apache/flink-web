...
## Apache Flink からヘルプを得るにはどうすればいいですか？

Apache Flink コミュニティから助けを得る方法はたくさんあります。[メーリングリスト](#mailing-list) は、すべての Flink コミッターが集まる主要な場所です。ユーザサポートや質問は *user mailing list* を使ってください。コミッターの中には [Stack Overflow](http://stackoverflow.com/questions/tagged/apache-flink) を監視している人もいます。質問には *[apache-flink](http://stackoverflow.com/questions/tagged/apache-flink)* タグをつけることを忘れないでください。バグや機能要求は *dev メーリングリスト* や [Jira]({{ site.jira }}) で議論することができます。Flink への貢献に興味のある方は [contributing guide](/contributing/how-to-contribute.html) をチェックしてください。
...
<table class="table table-striped">
  ...
  <tr>
    <td>
      ...
      <small>Flinkコミュニティからのニュースやお知らせ</small>
    </td>
  ...
  <tr>
    <td>
      ...
      <small>ミートアップ、会議、ブログ記事、求人情報に関連した幅広いコミュニティディスカッション</small>
    </td>
  ...
  <tr>
    <td>
      ...
      <small>ユーザーサポート・質問メーリングリスト</small>
    </td>
    ...
    <td>
      ...
      <small>中国のユーザーサポートと質問メーリングリスト</small>
    </td>
  ...
  <tr>
      <td>
        ...
        <small>Flinkのメインリポジトリのビルド通知</small>
      </td>
  ...
  <tr>
    <td>
      ...
      <br>
      <small>私たちのリポジトリへのすべてのコミット</small>
    </td>
