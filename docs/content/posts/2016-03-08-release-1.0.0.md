...
<center>
<img src="{{< siteurl >}}/img/blog/flink-1.0.png" style="height:200px;margin:15px">
</center>
...
This release resolves more than 450 issues, including bug fixes, improvements, and new features. See the [complete changelog]({{< siteurl >}}/blog/release_1.0.0-changelog_known_issues.html#changelog) and [known issues]({{< siteurl >}}/blog/release_1.0.0-changelog_known_issues.html#known-issues).
