...
![alt_text]({{< siteurl >}}/img/blog/release-19-flip1.png "Fine-grained Batch
Recovery") 
...
<div class="row"> <div class="col-sm-6"> <span><img class="thumbnail"
    src="{{< siteurl >}}/img/blog/release-19-web1.png" /></span> </div> <div
    class="col-sm-6"> <span><img class="thumbnail"
    src="{{< siteurl >}}/img/blog/release-19-web2.png" /></span> </div>
    </div>
...
Blink]({{< siteurl >}}/news/2019/02/13/unified-batch-streaming-blink.html) to
...
src="{{< siteurl >}}/img/blog/release-19-stack.png" /></span>
