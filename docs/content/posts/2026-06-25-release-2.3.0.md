...
aliases:
- /news/2026/06/25/release-2.3.0.html
authors:
- flink:
...
Previously, the SinkUpsertMaterializer has had poor performance and high resource consumption because it keeps the full history of updates for the primary key, leading to unbounded state growth. Flink 2.3 addresses this with a key improvement.
