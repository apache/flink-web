...
- fcsaky:
  name: "Ferenc Csaky"
aliases:
  - /news/2025/04/30/externalized-kudu-connector.html
---
...
For more details and examples, see the [DataStream connector documentation]({{< param DocsBaseUrl >}}flink-docs-release-1.20/docs/connectors/datastream/kudu/)
...
For other Table API related topics and examples, see the [Table API connector documentation]({{< param DocsBaseUrl >}}flink-docs-release-1.20/docs/connectors/table/kudu/)
