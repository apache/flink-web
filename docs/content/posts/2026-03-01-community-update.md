...
4. Enhancements around splits
   - [[FLINK-39073] Test split state timers during deferred alignment check](https://issues.apache.org/jira/browse/FLINK-39073)
...
5. Table planner enhancements
   ...
   - [[FLINK-39088] Support injective casts from CHAR/VARCHAR to BINARY/VARBINARY](https://issues.apache.org/jira/browse/FLINK-39088)
   - [[FLINK-38624] Type Mismatch Exception in StreamPhysicalOverAggregateRule](https://issues.apache.org/jira/browse/FLINK-38624)
