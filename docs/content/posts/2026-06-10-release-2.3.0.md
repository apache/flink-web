...
Note: The Native S3 FileSystem is experimental in Flink 2.3. It is functionally complete and has demonstrated strong performance in benchmarks, but more experience is needed before it can be recommended for use in production.
